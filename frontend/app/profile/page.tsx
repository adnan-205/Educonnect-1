...
export default function ProfilePage() {
  ...
  // If navigating from a gig "View Profile", pick up minimal info from localStorage
  useEffect(() => {
    try {
      if (typeof window === 'undefined') return
      const raw = localStorage.getItem('externalProfile')
      if (!raw) return
